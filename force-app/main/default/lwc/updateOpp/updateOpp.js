...
export default class updateOpp extends LightningElement {
    ...
    // event.currentTarget.dataset.id
    // var trID= event.target.value;
    // console.log(trID);
    // // var index = event.target.getAttribute('data-tr');
    // this.template.querySelector(`[data-target-id="${trID}"]`).style="background-color:green";
   
    // trID="#"+trID+'-113';
    // console.log(trID);
    
    //  this.template.querySelector(trID).style="background-color:green"
    //      console.log('@@currentRecordId@@@'+ this.colorchange);
        ...
        //  if(divblock){
        //      this.template.querySelector('[data-id="divblock"]').className='selected';
        //     //  this.ShowNo2button();
...
fortrue1(event){
    ...
    // target.style.backgroundColor= "#7FFF00";
     var target2=this.targetfalse;
     this.toggleval = event.target.value;
     this.task2Id = event.target.getAttribute('data-id');
     console.log('###taskId1: ' + this.trueid);
     console.log('###taskId2: ' + this.falseid);
...
fortrue2(event){
    ...
    console.log('###taskId2: ' + this.falseid);
    var target = event.target;
    this.targetfalse=target;
    this.toggleval = event.target.value;
    // target.style.backgroundColor= "#f44336";
    var target2=this.targettrue;
    this.task2Id = event.target.getAttribute('data-id');
